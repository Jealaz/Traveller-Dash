...
function Colis(){
  ...
  useEffect(() =>{
      axios.get('https://xnova-back-end.onrender.com/api/user/everyColisInfo').then((response) =>{
                        ...
                        <div class="overflow-scroll">
                          ...
                          <thead>
                              <tr>
                                ...
                                <th scope="col"><span class="th-title">Contact destinataire</span>
                                  <i class="bx bx-expand-vertical"></i>
                                </th>
                                ...
                                <th scope="col"><span class="th-title">Valeur du colis</span>
                                  <i class="bx bx-expand-vertical"></i>
                                </th>
